(function ($) {
    ...
    // thumbnail transfer_proof
    document.addEventListener("DOMContentLoaded", function () {
        const input = document.getElementById("transfer_proof");
        ...
        if (input && preview) {
            input.addEventListener("change", function () {
                ...
                preview.innerHTML = ""; // reset sebelumnya

                if (file) {
                    const filename = `<p class="mb-1"><strong>File:</strong> ${file.name}</p>`;
                    ...
                    if (file.type.startsWith("image/")) {
                        ...
                        reader.onload = function (e) {
                            preview.innerHTML = `
                            ${filename}
                            <img src="${e.target.result}" class="img-thumbnail rounded shadow-sm mt-2" style="max-height: 200px;" alt="Preview">
                        `;
                        };
    ...
    // Tab box
    if ($(".quote-tab").length) {
        $(".quote-tab .tabs-button-box .tab-btn-item").on(
            "click",
            function (e) {
                e.preventDefault();
                var target = $($(this).attr("data-tab"));
                ...
                if ($(target).hasClass("actve-tab")) {
                    ...
                    $(
                        ".quote-tab .tabs-content-box .tab-content-box-item"
    ...
    $(window).scroll(function () {
        ...
        $(".round-box-content .curved-circle").css({
